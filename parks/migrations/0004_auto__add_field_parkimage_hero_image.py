...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Parkimage.hero_image'
        db.add_column(u'parks_parkimage', 'hero_image',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Parkimage.hero_image'
        db.delete_column(u'parks_parkimage', 'hero_image')
    ...
    models = {
        ...
        u'parks.parkimage': {
            ...
            'hero_image': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
