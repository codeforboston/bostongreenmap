...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Facility.greenspace'
        db.alter_column('parkmap_facility', 'greenspace_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parkmap.Park'], null=True))
    def backwards(self, orm):
        ...
        # Changing field 'Facility.greenspace'
        db.alter_column('parkmap_facility', 'greenspace_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parkmap.Greenspace'], null=True))
    models = {
        'parkmap.facility': {
